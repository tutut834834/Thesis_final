...
def args_parser():
    ...
    # Scenario 1 / Hypothesis 1 non-IID control
    parser.add_argument('--class_per_agent', type=int, default=10,
                        help="number of classes per client; 10 = IID-ish, 2 = strongly non-IID")

    parser.add_argument('--verify_noniid', type=int, default=1,
                        help="1 = print client class distribution to prove the non-IID split")
    ...
    parser.add_argument('--seed', type=int, default=1,
                        help="random seed for reproducible non-IID split and poisoning")
