...
def args_parser():
    ...
    # Scenario 6 / Hypothesis 6: privacy-preserving training
    parser.add_argument('--privacy_mode', type=str, default='clip_noise',
                        choices=['none', 'clip_only', 'noise_only', 'clip_noise'],
                        help="privacy mechanism: none, clip_only, noise_only, clip_noise")

    parser.add_argument('--privacy_level', type=str, default='none',
                        choices=['none', 'low', 'medium', 'high'],
                        help="privacy intensity level")

    parser.add_argument('--verify_privacy_preserving', type=int, default=1,
                        help="1 = print privacy-preserving proof blocks")

    parser.add_argument('--privacy_report', type=int, default=1,
                        help="1 = print detailed privacy metrics and privacy schedule")

    parser.add_argument('--privacy_level_grid', type=str, default='none,low,medium,high',
                        help="documented privacy level grid")

    parser.add_argument('--scenario_name', type=str, default='hyp6_privacy_preserving',
                        help="scenario label written into txt logs and run names")

    parser.add_argument('--class_per_agent', type=int, default=10,
                        help="number of classes per client; 10 = IID-ish privacy scenario")
    ...
    parser.add_argument('--clean_label_type', type=int, default=0,
                        help="0 = dirty-label/default, 1 = plus, 2 = square, 3 = apple")
    ...
    parser.add_argument('--seed', type=int, default=1,
                        help="random seed for comparable privacy runs")

    # Raw defense/privacy parameters. They are automatically set by privacy_level in federated.py.
    parser.add_argument('--robustLR_threshold', type=int, default=0,
                        help="RobustLR threshold. Kept for compatibility")

    parser.add_argument('--clip', type=float, default=0,
                        help="privacy/update clipping bound. Automatically set by privacy_level")

    parser.add_argument('--noise', type=float, default=0,
                        help="server Gaussian noise multiplier. Automatically set by privacy_level")

    parser.add_argument('--privacy_noise_std', type=float, default=0,
                        help="effective privacy noise std, computed from clip and noise")

    parser.add_argument('--privacy_budget_proxy', type=float, default=0,
                        help="simple proxy score for privacy strength; logged for thesis comparison")
