...
PC_NAME = "PC05_H3_pf025_dirty"
BRANCH_NAME = "pc05-h3-pf025-dirty"
...
def sync_visible_pc_folder():
    ...
    Keep a visible PC03 folder in GitHub:
      PC05_H3_pf025_dirty/
      PC05_H3_pf025_dirty/output_logs/
    """
    try:
        ...
        for fname in [
            ...
            "options.py",
            "utils.py",
            "PC05_H3_pf025_dirty_description_expectation.txt"
        ]:
...
def github_upload_round(rnd):
    """
    Uploads current code and txt logs to GitHub branch pc05-h3-pf025-dirty.
    Safe behavior:
    ...
    try:
        ...
        commit_code = run_cmd(f'git commit -m "PC05 auto upload round {rnd}"', timeout=30)
