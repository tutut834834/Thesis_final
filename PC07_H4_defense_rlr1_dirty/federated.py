...
PC_NAME = "PC07_H4_defense_rlr1_dirty"
BRANCH_NAME = "pc07-h4-defense-rlr1-dirty"
...
def sync_visible_pc_folder():
    ...
    Keep a visible PC03 folder in GitHub:
      PC07_H4_defense_rlr1_dirty/
      PC07_H4_defense_rlr1_dirty/output_logs/
    """
    try:
        ...
        for fname in [
            ...
            "options.py",
            "utils.py",
            "PC07_H4_defense_rlr1_dirty_description_expectation.txt"
        ]:
...
def github_upload_round(rnd):
    """
    Uploads current code and txt logs to GitHub branch pc07-h4-defense-rlr1-dirty.
    Safe behavior:
    ...
    try:
        ...
        commit_code = run_cmd(f'git commit -m "PC07 auto upload round {rnd}"', timeout=30)
