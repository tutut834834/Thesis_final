...
PC_NAME = "PC06_H3_pf025_clean"
BRANCH_NAME = "pc06-h3-pf025-clean"
...
def sync_visible_pc_folder():
    ...
    Keep a visible PC03 folder in GitHub:
      PC06_H3_pf025_clean/
      PC06_H3_pf025_clean/output_logs/
    """
    try:
        ...
        for fname in [
            ...
            "options.py",
            "utils.py",
            "PC06_H3_pf025_clean_description_expectation.txt"
        ]:
...
def github_upload_round(rnd):
    """
    Uploads current code and txt logs to GitHub branch pc06-h3-pf025-clean.
    Safe behavior:
    ...
    try:
        ...
        commit_code = run_cmd(f'git commit -m "PC06 auto upload round {rnd}"', timeout=30)
