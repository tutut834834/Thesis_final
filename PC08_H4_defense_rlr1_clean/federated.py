...
PC_NAME = "PC08_H4_defense_rlr1_clean"
BRANCH_NAME = "pc08-h4-defense-rlr1-clean"
...
def sync_visible_pc_folder():
    ...
    Keep a visible PC03 folder in GitHub:
      PC08_H4_defense_rlr1_clean/
      PC08_H4_defense_rlr1_clean/output_logs/
    """
    try:
        ...
        for fname in [
            ...
            "options.py",
            "utils.py",
            "PC08_H4_defense_rlr1_clean_description_expectation.txt"
        ]:
...
def github_upload_round(rnd):
    """
    Uploads current code and txt logs to GitHub branch pc08-h4-defense-rlr1-clean.
    Safe behavior:
    ...
    try:
        ...
        commit_code = run_cmd(f'git commit -m "PC08 auto upload round {rnd}"', timeout=30)
