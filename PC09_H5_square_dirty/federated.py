...
PC_NAME = "PC09_H5_square_dirty"
BRANCH_NAME = "pc09-h5-square-dirty"
...
def sync_visible_pc_folder():
    ...
    Keep a visible PC03 folder in GitHub:
      PC09_H5_square_dirty/
      PC09_H5_square_dirty/output_logs/
    """
    try:
        ...
        for fname in [
            ...
            "options.py",
            "utils.py",
            "PC09_H5_square_dirty_description_expectation.txt"
        ]:
...
def github_upload_round(rnd):
    """
    Uploads current code and txt logs to GitHub branch pc09-h5-square-dirty.
    Safe behavior:
    ...
    try:
        ...
        commit_code = run_cmd(f'git commit -m "PC09 auto upload round {rnd}"', timeout=30)
