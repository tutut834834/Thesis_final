...
PC_NAME = "PC04_H2_stealth_clean"
BRANCH_NAME = "pc04-h2-stealth-clean"
...
def sync_visible_pc_folder():
    ...
    Keep a visible PC03 folder in GitHub:
      PC04_H2_stealth_clean/
      PC04_H2_stealth_clean/output_logs/
    """
    try:
        ...
        for fname in [
            ...
            "options.py",
            "utils.py",
            "PC04_H2_stealth_clean_description_expectation.txt"
        ]:
...
def github_upload_round(rnd):
    """
    Uploads current code and txt logs to GitHub branch pc04-h2-stealth-clean.
    Safe behavior:
